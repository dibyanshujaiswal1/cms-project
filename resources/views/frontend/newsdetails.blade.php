                ...
                <div class="breadcrumb-style gva-parallax-background" style="background-repeat: no-repeat; height:9px">
                        <div class="container">
                            <div class="breadcrumb-content-main">
                                <h2 class="page-title">{{$newsdetails->title}} </h2>
                                <div class="">
                                            ...
                                            <article data-history-node-id="8" role="article" about="/drupal/kunco/close-shot-blue-and-cream-coloured" typeof="schema:Article" class="node node-detail node--type-article node--promoted node--view-mode-full clearfix">
                                                <div class="post-block">
                                                    ...
                                                    <div class="post-thumbnail post-standard">
                                                        ...
                                                        <div class="field field--name-field-image field--type-image field--label-hidden field__item">
                                                            <div class="item-image">
                                                                <img property="schema:image" src="{{asset('backend/img/news/'.$newsdetails->image)}}" alt="alt" style="height:450px; width:700px" typeof="foaf:Image" class="mobile-view" />
                                                    ...
                                                    <div class="post-content">
                                                        ...
                                                        <h1 class="post-title"><span property="schema:name">{{$newsdetails->title}}</span>
                                                        </h1>
                                                        ...
                                                        <div class="post-meta">
                                                           ...
                                                           <h5> <span class="post-created">{{\Carbon\Carbon::parse($newsdetails->date)->format('d-M-Y')}}</span> </h5>
                                                        ...
                                                        <div class="node__meta">
                                                            ...
                                                            <span>
                                                                <span rel="schema:author"><span lang="" about="/drupal/kunco/user/1" typeof="schema:Person" property="schema:name" datatype="">{!! Str::limit($newsdetails->short_description,100)!!}</span></span>
                                                                </span>
                                                        ...
                                                        <div class="node__content clearfix">
                                                            ...
                                                            <div property="schema:text" class="field field--name-body field--type-text-with-summary field--label-hidden field__item">
                                                                <p>{!! $newsdetails->long_description!!}.</p>
                                        ...
                                        <div>
                                            <div class="post-style-list small gva-view js-view-dom-id-67d29666627901db50b94b7d5825966ad05cb08547f4d38ace9034bc87bb714c">
                                                <div class="item-list">
                                                    ...
                                                    @foreach($allnews as $newsdetails)
                                                                ...
                                                                <div class="field-content">
                                                                    <div class="post-block">
                                                                        <div class="post-image">
                                                                            <div class="item-image">
                                                                                <a href="{{route('view.newsdetails',$newsdetails->id)}}"><img src="{{asset('backend/img/news/'.$newsdetails->image)}}" alt="alt" style="height:80px; width:500px" typeof="Image" />

                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="post-content">
                                                                            <div class="post-title"> <a href="{{route('view.newsdetails',$newsdetails->id)}}" hreflang="en">{{$newsdetails->title}}</a> {!!str::limit($newsdetails->short_description,80)!!}</div>
