            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        ...
                        @endif
                        <form class="user" action="{{route('add.about')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12 mb-3 mb-sm-0">
                                    ...
                                    <input type="text" class="form-control " name="heading" id="exampleFirstName" placeholder="About Us Heading">
                                    @error('heading')
