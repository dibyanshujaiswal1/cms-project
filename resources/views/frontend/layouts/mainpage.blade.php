                                                                                                                ...
                                                                                                                <div id="ez933" class="rev_slider fullwidthabanner" data-version="5.4.1">
                                                                                                                    <ul>
                                                                                                                        ...
                                                                                                                        <li data-transition="random" data-easein="Power0.easeIn" data-easeout="Power1.easeOut" data-slotamount="7" data-kenburns="off" data-masterspeed="default" data-index="{{$loop->first?'rs-1':''}}">
                                                                                                                            ...
                                                                                                                            <div class="tp-caption text text-white text-center slide-style-2" data-x="center" data-y="195" data-start="1205.48" data-transform_idle="o:1;" data-transform_in="x:inherit;y:inherit;z:0;rX:0;rY:0;rZ:0;sX:0;sY:0;skX:0;skY:0;opacity:0;s:600;e:easeOutExpo;" style="z-index:4; margin-top: 140px;">
                                                                                                                                {{$banners->banner_heading}}
                                                                                                                            </div>
                                                                                                                            <div class="tp-caption text text-white text-center slide-style-3 " data-x="center" data-y="370" data-start="1546.58" data-transform_idle="o:1;" data-transform_in="x:inherit;y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;s:600;e:easeOutExpo;" style="z-index:3;margin-top: 70px;">
                                                                                                                                {{$banners->description}}
                                                                                                                            </div>
                                                                                                                        </li>
                                                                                                                        @endforeach
