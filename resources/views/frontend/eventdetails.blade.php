                ...
                <div class="breadcrumb-style gva-parallax-background" style="background-repeat: no-repeat; height:9px">
                        <div class="container">
                            <div class="breadcrumb-content-main">
                                <h2 class="page-title">{{$eventdetails->title}} </h2>
                                <div class="">
                                            ...
                                            <article data-history-node-id="8" role="article" about="/drupal/kunco/close-shot-blue-and-cream-coloured" typeof="schema:Article" class="node node-detail node--type-article node--promoted node--view-mode-full clearfix">
                                                <div class="post-block">
                                                    ...
                                                    <div class="post-thumbnail post-standard">
                                                        ...
                                                        <div class="field field--name-field-image field--type-image field--label-hidden field__item">
                                                            <div class="item-image">
                                                                <img property="schema:image" src="{{asset('backend/img/event/'.$eventdetails->image)}}" alt="alt" style="height:450px; width:700px" typeof="foaf:Image" class="mobile-view" />
                                                    ...
                                                    <div class="post-content">
                                                        ...
                                                        <h1 class="post-title"><span property="schema:name">{{$eventdetails->title}}</span>
                                                        </h1>
                                                        ...
                                                        <div class="post-meta">
                                                            ...
                                                            <h5> <span class="post-created">{{\Carbon\Carbon::parse($eventdetails->date)->format('d-M-Y')}}</span> </h5>
                                                        ...
                                                        <div class="node__meta">
                                                            ...
                                                            <span>
                                                                <span rel="schema:author"><span lang="" about="/drupal/kunco/user/1" typeof="schema:Person" property="schema:name" datatype="">{{$eventdetails->vanue}}</span></span>
                                                            </span>
                                            ...
                                            <div class="post-style-list small gva-view js-view-dom-id-67d29666627901db50b94b7d5825966ad05cb08547f4d38ace9034bc87bb714c">
                                                <div class="item-list">
                                                    <ul>
                                                        ...
                                                        @foreach($allevent as $eventdetails)
                                                                ...
                                                                <div class="field-content">
                                                                    <div class="post-block">
                                                                        <div class="post-image">
                                                                            <div class="item-image">
                                                                                <a href="{{route('view.eventdetails',$eventdetails->id)}}"><img src="{{asset('backend/img/event/'.$eventdetails->image)}}" alt="alt"  typeof="Image" />

                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="post-content">
                                                                            <div class="post-title"> <a href="{{route('view.eventdetails',$eventdetails->id)}}" hreflang="en">{{$eventdetails->title}}</a> {{\Carbon\Carbon::parse($eventdetails->date)->format('d-M-Y')}}</div>
                                                                            <div class="post-title">{{$eventdetails->vanue}}</div>
