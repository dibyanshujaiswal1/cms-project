                        ...
                        <form class="user" action="{{route('update.publication',$data->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 mb-3 mb-sm-0">
                                    ...
                                    <textarea name="description" class="form-control " id="description" placeholder="Description" value="{{$data->description}}">{{$data->description}}</textarea>
                                </div>
                                <div class="col-sm-12 mb-3 mb-sm-0">
                                ...
                                <div class="col-sm-12 mb-3 mb-sm-0">
                                    ...
                                    <select class="form-control " name="publication_type" id="exampleFirstName" placeholder="Publication Type">
                                        <option value="our" {{$data->publication_type=='our'?'selected':''}}>Our publication</option>
                                        <option value="refrence" {{$data->publication_type=='refrence'?'selected':''}}>Refrence Publication</option>
                                        <option value="reports" {{$data->publication_type=='reports'?'selected':''}}>Reports Publication</option>
                                    </select>
                                </div>
